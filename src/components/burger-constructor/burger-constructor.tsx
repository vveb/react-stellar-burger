...
const BurgerConstructor = () => {
  ...
  const isOrderPending: boolean = useSelector((store) => store.api.isOrderPending);
  ...
  const handleDrop = (itemData: Ingredient) => {
  ...
  const assignOrderNumber = (bun: Ingredient | null, others: Ingredient[]) => {
